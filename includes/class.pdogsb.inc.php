...
class PdoGsb {
     ...
     *
     * @param String $nom Nom de l'utilisateur recherché
     * @param String $prenom Prenom de l'utilisateur recherché
     *
     * @return l'id de l'utilisateur rechecrhé
     */
    public function getIdUtilisateur($nom, $prenom) {
    ...
    public function getInfosVisiteur($login, $mdp) {
        ...
        // Si le visiteur n'existe pas, on vérifie s'il n'est pas un compable
        if (!is_array($visiteur)) {
            $visiteur = $this->getInfosComptable($login, $mdp);
        }
        return $visiteur;
    }
     ...
     * Enregistre la valeur 'comptable' dans la variable de session
     * 
     ...
     * id, nom et prénom de tous les visiteurs
     * 
     * @return array[$i][id, nom, prenom]
     */
